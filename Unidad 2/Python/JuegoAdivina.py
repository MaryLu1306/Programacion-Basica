...
Indica el intervalo en el que se encuentra el numero secreto 
2. ¿Qué tipo es la variable intentos? 
Enteros
3. ¿Qué estamos haciendo en la línea 1? 
Se esta declarando un comentario
4. ¿Mencione los operadores que se utilizan en el código? 
De asignacion, aritmeticos, relacionales
5. ¿Qué hace la palabra intentos que está entre corchetes? 
Busca indicar el numero de intentos que se utilizaron para adivinar el numero secreto 
